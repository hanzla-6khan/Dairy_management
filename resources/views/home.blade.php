...
@section('content')
    ...
    {{-- ============== bilty ===========  --}}
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-3 ">
                <a href="{{ route('bilties.index') }}" class="card-link">
                    <div class="card">
                        <img src="{{ asset('images/gallery.png') }}" class="card-img" alt="...">
                        <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center">
                            <div class="card-content text-center mt-3">
                                <p style="color: rgb(20, 8, 8); font-weight: bold; font-size: 20px;">Add bilty </p>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-3 ">
                <a href="{{ route('bilties.create') }}" class="card-link">
                    <div class="card">
                        <img src="{{ asset('images/add-to-cart.png') }}" class="card-img" alt="...">
                        <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="col-md-3 ">
                ...
                <a href="{{ route('bilties.show') }}" class="card-link">
                    <div class="card">
                        <img src="{{ asset('images/shopping-bag.png') }}" class="card-img" alt="...">
                        <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center">
                            <div class="icon">
