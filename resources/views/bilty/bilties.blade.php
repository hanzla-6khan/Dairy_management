...
@section('content')
 ...
 <div class="card-body">
                 ...
                 <form action="{{ route('bilties.store') }}" method="POST">
    @csrf
                        <div class="form-row">
                            <!-- Search Customer -->
                            <div class="col-md-4 mb-3">
                                <label for="searchCustomer">Search Customer</label>
                                <input type="text" class="form-control" id="searchCustomer" placeholder="Customer"
                                    required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="trackNo" placeholder="Track No" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="trackRead" placeholder="Track Read" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="factory" placeholder="Factory" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="costPackage" placeholder="Cost per Package"
                                    required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="totalCost" placeholder="Total Cost" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="preBalance" placeholder="Previous Balance"
                                    required>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="nowBalance" placeholder="Current Balance"
                                    required>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-control" placeholder="enter sms" type="text" id="sendSMS" required>
